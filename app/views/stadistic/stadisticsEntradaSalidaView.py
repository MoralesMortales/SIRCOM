...
from app.functions.window_funtions.stadistics.ColorLegend import \
    ColorLegendWidget
from app.views.management.sidebarView import sidebarView
from app.windows.py.stadisticsEntradaSalidaWds import Ui_Form


class stadisticEntradaSalidaView(QWidget, Ui_Form):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
        self.setWindowTitle("Estadísticas 2")
        ...
        # Conectar botones
        self.materialesBtn.clicked.connect(self.showMateriales)
        self.mostrar_grafica_entradas_salidas()

    def setup_matplotlib(self):
        """Configurar matplotlib en el frame vacío"""
    ...
    def setup_materiales_list(self):
        """Configurar la lista de materiales con colores"""
        # Limpiar lista existente
        self.listWidget.clear()

        # Datos de ejemplo - puedes cambiar por tus datos reales
        self.materiales_data = [
            {"nombre": "Entradas", "color": "#FF6B6B", "porcentaje": 5},
            {"nombre": "Salidas", "color": "#45B7D1", "porcentaje": 95},
        ]
    ...
    def mostrar_grafica_entradas_salidas(self):
        self.figure.clear()
        ...
        ax.set_title(
            "Distribución de Materiales", pad=20, fontsize=14, fontweight="bold"
        )

    def showMateriales(self):
        from app.views.stadistic.stadisticsMaterialView import stadisticMaterialView

        self.materiales = stadisticMaterialView()
        self.materiales.showMaximized()
        self.close()
