...
# Form implementation generated from reading ui file './app/windows/ui/emailCode.ui'
#
...
"}")
        ...
        self.verticalLayout_4.addWidget(self.labelCodigo, 0, QtCore.Qt.AlignHCenter)
        self.lineEditCodigo = QtWidgets.QLineEdit(self.panelDerecho)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEditCodigo.sizePolicy().hasHeightForWidth())
        self.lineEditCodigo.setSizePolicy(sizePolicy)
        self.lineEditCodigo.setMinimumSize(QtCore.QSize(0, 0))
        self.lineEditCodigo.setBaseSize(QtCore.QSize(0, -3968))
        self.lineEditCodigo.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.lineEditCodigo.setObjectName("lineEditCodigo")
        self.verticalLayout_4.addWidget(self.lineEditCodigo)
        ...
        self.buttonComprobar = QtWidgets.QPushButton(self.panelDerecho)
        self.buttonComprobar.setMinimumSize(QtCore.QSize(250, 0))
        self.buttonComprobar.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.buttonComprobar.setObjectName("buttonComprobar")
        self.verticalLayout_3.addWidget(self.buttonComprobar, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, Form):
        ...
        self.labelCodigo.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt;\">Ingrese el código </span></p><p align=\"center\"><span style=\" font-size:18pt;\">enviado a su correo</span></p></body></html>"))
        self.buttonComprobar.setText(_translate("Form", "Comprobar"))
